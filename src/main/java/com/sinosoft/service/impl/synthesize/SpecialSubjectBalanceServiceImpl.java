...
public class SpecialSubjectBalanceServiceImpl implements SpecialSubjectBalanceService {
    ...
    private void getSubjectSpecialBalance(String itemCode, List centerCode, List branchCode, String accBookType, String accBookCode, List<String> specialCondition, String startYearMonth, String endYearMonth, String cumulativeAmount, boolean chargeFlag, List result,String specialNameP) {
        ...
        //未结转期间已记账/未记、已记账账凭证处理
        //1.计入期末余额
        Map<String, Map<String, String>> noChargeItemBq = getNoChargeItemBq(chargeFlag, centerCode, branchCode, accBookType, accBookCode, itemCode, specialCondition, startYearMonth, endYearMonth);
...
//            BigDecimal _balanceQc = qcDataMap == null ? new BigDecimal(0.00) : new BigDecimal(qcDataMap.get("balanceQm"));//期初余额
    ...
    //获取未结转期间（已记账、未记账）/已记账（未结转期间）--本年发生额
    ...
    private Map<String, Map<String, String>> getNoChargeItemBq(boolean flag, List centerCode, List branchCode, String accBookType, String accBookCode, String itemCode, List<String> specialCondition, String startYearMonth, String endYearMonth) {
