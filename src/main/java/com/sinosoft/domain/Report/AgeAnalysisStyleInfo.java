...
@Entity
@Table(name = "ageanalysisstyleinfo")
public class AgeAnalysisStyleInfo {

    @EmbeddedId
    private AgeAnalysisStyleInfoId id;//联合主键
    private String d1; //表头field
    private String d2; //表头title
    private String d3; //表头width
    private String d4; //表头halign
    private String d5; //表头align
    private String d6; //表头rowspan
    private String d7; //表头colspan
    private String d8;
    private String d9;
    private String d10;
    private String d11;
    ...
    public AgeAnalysisStyleInfoId getId() {
        return id;
    }

    public void setId(AgeAnalysisStyleInfoId id) {
        this.id = id;
    }
