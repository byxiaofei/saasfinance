...
@Entity
@Table(name = "reportstyleinfo")
public class ReportStyleInfo {

    @EmbeddedId
    private ReportStyleInfoId id;//联合主键
    ...
    public ReportStyleInfoId getId() {
        return id;
    }

    public void setId(ReportStyleInfoId id) {
        this.id = id;
    }
