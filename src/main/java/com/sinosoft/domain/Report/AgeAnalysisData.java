...
@Entity
@Table(name = "ageanalysisdata")
public class AgeAnalysisData {

    @EmbeddedId
    private AgeAnalysisDataId id;//联合主键
    private String d1; //
    private String d2;
    private String d3;
    private String d4;
    ...
    public AgeAnalysisData() { }

    public AgeAnalysisData(AgeAnalysisDataId id) { this.id = id; }

    public AgeAnalysisDataId getId() {
        return id;
    }

    public void setId(AgeAnalysisDataId id) {
        this.id = id;
    }
