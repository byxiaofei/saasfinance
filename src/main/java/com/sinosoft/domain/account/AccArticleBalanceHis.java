...
@Entity
@Table(name = "accarticlebalancehis")
public class AccArticleBalanceHis {
    @EmbeddedId
    ...
    public AccArticleBalanceHis() { }
    public AccArticleBalanceHis(AccArticleBalanceId id) { this.id = id; }
