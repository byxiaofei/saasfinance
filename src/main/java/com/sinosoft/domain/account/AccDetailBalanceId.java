...
@Embeddable
public class AccDetailBalanceId implements Serializable {
    ...
    public AccDetailBalanceId() {}
    public AccDetailBalanceId(String centerCode, String branchCode, String accBookType, String accBookCode, String yearMonthDate, String itemCode, String directionIdx) {
