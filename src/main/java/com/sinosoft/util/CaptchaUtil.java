...
public final class CaptchaUtil
{
    ...
    private static Color getReverseColor(Color c)
    {
        ...
        return new Color(255 - random.nextInt(255), 255 - random.nextInt(255),255- random.nextInt(255));
    }
            ...
            throws ServletException, IOException 
    {
        ...
        Thread t1 = new MyThread(session);
        t1.start();
       ...
       // session.setMaxInactiveInterval(10);
        ...
        g.setColor(reverse);
        g.drawString(randomString, 8, 25);
...
class MyThread extends  Thread{
    ...
    public void run() {
        ...
        try{
            Thread.sleep(60000);
            System.out.println("验证码"+ session.getAttribute("randomString") +"以过期");
            session.removeAttribute("randomString");
