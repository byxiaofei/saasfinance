...
public class AccAssetInfoChangeDTO {
   ...
   // private String createBy;            //制单人
    ...
    private String changeNewDataRight;
    private String changeOldDataRight;
    ...
    public String getChangeNewDataRight() {
        return changeNewDataRight;
    }

    public void setChangeNewDataRight(String changeNewDataRight) {
        this.changeNewDataRight = changeNewDataRight;
    }

    public String getChangeOldDataRight() {
        return changeOldDataRight;
    }

    public void setChangeOldDataRight(String changeOldDataRight) {
        this.changeOldDataRight = changeOldDataRight;
    }
